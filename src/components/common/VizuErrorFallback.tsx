  ...
  return (
    <div className="min-h-screen w-full bg-[var(--app-primary)] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 max-w-md w-full bg-[color-mix(in_srgb,var(--app-bg-ghost)_90%,transparent)] border border-[color-mix(in_srgb,var(--app-accent)_30%,transparent)] rounded-[2.5rem] p-8 shadow-2xl backdrop-blur-xl flex flex-col items-center text-center animate-fade-in">
        ...
        <p className="text-xs text-primary/40 dark:text-white/40 leading-relaxed mb-6 max-w-xs">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full">
          {reset && (
            <button
              onClick={reset}
              className="w-full flex-1 flex items-center justify-center gap-2 py-3.5 px-5 rounded-2xl bg-[var(--app-accent)] hover:bg-[var(--app-accent-light)] text-primary dark:text-white font-black text-xs uppercase tracking-wider transition-all shadow-lg active:scale-95 cursor-pointer"
            >
              <RefreshCw size={16} />
              Try Again
            </button>
          ...
          <button
            ...
            className="w-full flex-1 flex items-center justify-center gap-2 py-3.5 px-5 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/20 text-primary dark:text-white font-bold text-xs uppercase tracking-wider transition-all active:scale-95 cursor-pointer"
          >
            <Home size={16} />
            Go Home
          </button>
