...
export const Login: React.FC<LoginProps> = ({
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#E8F6F4] p-4 sm:p-6 lg:p-8 animate-fade-in relative overflow-hidden font-lexend">
      ...
      <div className="relative w-full max-w-md bg-white border border-[color-mix(in_srgb,var(--app-primary)_5%,transparent)] rounded-[2.2rem] p-6 sm:p-8 shadow-xl text-primary dark:text-white my-auto transition-all">
        ...
        {mode === 'login' ? (
          <>
            ...
            <div className="text-left mb-6">
              <h1 className="text-2xl sm:text-3xl font-bold tracking-tight font-montserrat text-primary dark:text-white">
                Login
              </h1>
...
<form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="login-identifier" className="text-xs font-semibold text-primary dark:text-white">
                  Username or Email
                </label>
              ...
              {/* Field 2: Password */}
              <div className="flex flex-col gap-1.5">
                <label htmlFor="login-password" className="text-xs font-semibold text-primary dark:text-white">
                  Password
                </label>
                <div className="relative flex items-center">
              ...
              <div className="flex items-center justify-between pt-1">
                <label htmlFor="rememberMe" className="flex items-center gap-2 cursor-pointer select-none text-xs font-semibold text-primary dark:text-white hover:text-[var(--app-accent)] transition-colors">
                  <input
                    type="checkbox"
                    id="rememberMe"
                    name="rememberMe"
          ...
          <>
            ...
            <div className="text-left mb-6">
              ...
              <h1 className="text-2xl font-extrabold tracking-tight font-montserrat text-primary dark:text-white">
                Reset Password
              </h1>
              <p className="text-xs sm:text-sm text-[color-mix(in_srgb,var(--app-primary)_60%,transparent)] mt-1">
            ...
            {resetSuccess ? (
              <div className="py-6 flex flex-col items-center text-center space-y-4">
                ...
                <h3 className="font-bold text-primary dark:text-white text-base">Check your inbox</h3>
                <p className="text-xs text-[color-mix(in_srgb,var(--app-primary)_70%,transparent)] max-w-xs">
                  We've sent recovery instructions to <span className="font-semibold text-primary dark:text-white">{resetEmail}</span>.
                </p>
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="mt-4 w-full bg-[var(--app-accent)] hover:bg-[#25A89B] text-primary dark:text-white font-bold py-3.5 rounded-full shadow-md transition-all"
                >
                  Back to Login
                </button>
              </div>
              ...
              <form onSubmit={handleResetSubmit} className="space-y-4" noValidate>
                ...
                <button
                  ...
                  className="w-full mt-6 bg-[var(--app-accent)] hover:bg-[#25A89B] text-primary dark:text-white font-bold py-3.5 px-6 rounded-full shadow-md hover:shadow-lg active:scale-95 transition-all flex items-center justify-center gap-2.5 disabled:opacity-70"
                >
                  {resetLoading ? (
                    <>
                      <Loader2 size={18} className="animate-spin" />
