...
export const Signup: React.FC<SignupProps> = ({
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#E8F6F4] p-4 sm:p-6 lg:p-8 animate-fade-in relative overflow-hidden font-lexend">
      ...
      <div className="relative w-full max-w-md bg-white border border-[color-mix(in_srgb,var(--app-primary)_5%,transparent)] rounded-[2.2rem] p-6 sm:p-8 shadow-xl text-[var(--app-primary)] my-auto">
        {/* Top Navigation Bar */}
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="signup-name" className="text-xs font-semibold text-[var(--app-primary)]">
              Full Name
            </label>
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="signup-email" className="text-xs font-semibold text-[var(--app-primary)]">
              Email Address
            </label>
            <div className="relative flex items-center">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="signup-password" className="text-xs font-semibold text-[var(--app-primary)]">
              Create Password
            </label>
            <div className="relative flex items-center">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="signup-confirm-password" className="text-xs font-semibold text-[var(--app-primary)]">
              Confirm Password
            </label>
            <div className="relative flex items-center">
              <Lock size={18} className="absolute left-3.5 text-[color-mix(in_srgb,var(--app-primary)_40%,transparent)] pointer-events-none" />
          ...
          <div className="pt-1">
            <label htmlFor="signup-terms" className="flex items-center gap-2.5 cursor-pointer select-none text-xs text-[color-mix(in_srgb,var(--app-primary)_80%,transparent)] hover:text-[var(--app-primary)] transition-colors">
              <input
                id="signup-terms"
                type="checkbox"
                name="termsAccepted"
